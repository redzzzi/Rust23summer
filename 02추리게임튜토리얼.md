...
<br><br>
# Guessing game
```0️.``` 1~100 random integer generated<br>
```1️.``` input the integer guessed by a player on the program<br>
```2️.``` show whether the guessed number is higher/lower than the ans<br>
```3️.``` correct → congrats msg & exit<br><br>
