...
~~내 원 코드에서 저 부분만 편집하니까 컴파일이 성공해서 환경을 아예 똑같이 만들어줌~~
```cargo test```
<br><br>
그러면 이런 코드가 컴파일 에러가 뜬다<br>
<img src="https://github.com/redzzzi/Rust23summer/assets/127263392/bd2f5fe7-2d1b-4a2e-9c32-3df8ea25e6fc" width="500px">
